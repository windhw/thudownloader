...
class ddTaskBarIcon(wx.TaskBarIcon):
    ...
    def CreateMenu(self):
        ...
        self.HIDE=wx.NewId()
        self.RESTORE=wx.NewId()
        self.Bind(wx.EVT_TASKBAR_RIGHT_UP, self.ShowMenu)  
        self.menu=wx.Menu()
        self.menu.Append(self.HIDE, u"把主窗口最小化到托盘","This will open a new Browser with tabs for each account")  
        self.menu.Append(self.RESTORE, u"恢复主窗口")  
        self.menu.AppendSeparator()  
        self.menu.Append(wx.ID_EXIT, u"退出网络学堂助手") 
...
class MainFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.toolDownAll=self.mainFrame_toolbar.AddLabelTool(wx.NewId(), _(u"下载更新"), wx.Bitmap("extra\\DownAll.png", wx.BITMAP_TYPE_PNG), wx.NullBitmap, wx.ITEM_NORMAL, _(u"下载所有课件，更新所有公告，您可以去喝咖啡啦:）"), "")
        self.toolDownAllFiles=self.mainFrame_toolbar.AddLabelTool(wx.NewId(), _(u"下载课件"), wx.Bitmap("extra\\DownFile.png", wx.BITMAP_TYPE_PNG), wx.NullBitmap, wx.ITEM_NORMAL, _(u"下载所有课件"), "")
        self.toolRefreshNotes=self.mainFrame_toolbar.AddLabelTool(wx.NewId(), _(u"更新公告"), wx.Bitmap("extra\\Notice.png", wx.BITMAP_TYPE_PNG), wx.NullBitmap, wx.ITEM_NORMAL, _(u"更新所有公告"), "")
        self.tollRefreshAll=self.mainFrame_toolbar.AddLabelTool(wx.NewId(), _(u"刷新"), wx.Bitmap("extra\\Refresh.png", wx.BITMAP_TYPE_PNG), wx.NullBitmap, wx.ITEM_NORMAL, _(u"重新查询课件"), "")
        ...
        self.toolHide=self.mainFrame_toolbar.AddLabelTool(wx.NewId(), _(u"最小化到托盘"), wx.Bitmap("extra\\Hide.png", wx.BITMAP_TYPE_PNG), wx.NullBitmap, wx.ITEM_NORMAL, _(u"最小化到任务栏托盘"), "")
        # Tool Bar end
